...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_dflt1_Pin|RTDS_Pin|LED_dflt2_Pin|LED_temp_Pin
  ...
  /*Configure GPIO pins : LED_dflt1_Pin RTDS_Pin LED_dflt2_Pin LED_temp_Pin
                           LED_brake_Pin RUN_Pin RFE_Pin */
  GPIO_InitStruct.Pin = LED_dflt1_Pin|RTDS_Pin|LED_dflt2_Pin|LED_temp_Pin
                          |LED_brake_Pin|RUN_Pin|RFE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
